...
function injectLanguageSelectors(currentLang) {
  ...
  // En la landing page: inyectar dentro del contenedor del nav
  const landingLangSlot = document.getElementById("landing-lang-slot");
  if (landingLangSlot && !landingLangSlot.querySelector(".corespeak-ui-lang-dropdown")) {
    buildLangDropdown(landingLangSlot, true);
  }
...
const CORESPEAK_PAGE_I18N = {
  es: {
    ...
    landing: {
      ...
      heroSub: "Micro-retos de 5 minutos al día. Feedback instantáneo de tu tutor IA. Construye el hábito de aprender, día a día.",
      heroCta: "Empezar gratis", heroHow: "Cómo funciona",
      featTitle: "Todo lo que necesitas para", featGradient: "aprender de verdad",
      featSub: "Diseñado para ser breve, efectivo y adaptado a tu nivel.",
      feat1Title: "Retos inteligentes", feat1Desc: "Un micro-reto nuevo cada día, ajustado a tu nivel CEFR. Solo 5 minutos bastan.",
      feat2Title: "Tutor con IA", feat2Desc: "Feedback personalizado al instante. La IA explica tus errores y celebra tus aciertos.",
      feat3Title: "Rachas y XP", feat3Desc: "Acumula puntos de experiencia, mantén tu racha diaria y sube de nivel con cada reto.",
      feat4Title: "Agenda de vocabulario", feat4Desc: "Guarda las palabras que aprendes y repásalas cuando quieras. Tu diccionario personal.",
      hiwTitle: "Empezar es", hiwGradient: "muy sencillo", hiwSub: "Tres pasos y estarás aprendiendo hoy mismo.",
      step1Title: "Crea tu perfil", step1Desc: "Elige el idioma que quieres aprender y cuéntanos tu nivel actual. Tarda menos de 2 minutos.",
      step2Title: "Completa tu reto diario", step2Desc: "Cada día un ejercicio nuevo: escucha, escribe o responde preguntas con ayuda del tutor IA.",
      step3Title: "Sigue tu progreso", step3Desc: "Observa cómo subes de nivel, mantienes tu racha y acumulas vocabulario semana a semana.",
      langTitle: "Idiomas disponibles", langSub: "Elige el que más te interese. Puedes aprender varios a la vez.",
      langEn: "Inglés", langFr: "Francés", langUa: "Ucraniano", langEs: "Español",
      premTitle: "Desbloquea el tutor IA sin límites",
      premSub: "Conversa con tu tutor cuando quieras, accede a todos los cursos y retos avanzados. Todo desde solo €5/mes.",
      premBtn: "Ver planes",
      ftLogin: "Iniciar sesión", ftRegister: "Registrarse", ftPricing: "Precios",
      ftCopy: "© 2026 CoreSpeak. Todos los derechos reservados.",
  ...
  en: {
    ...
    landing: {
      ...
      heroSub: "5-minute micro-challenges every day. Instant feedback from your AI tutor. Build the habit of learning, one day at a time.",
      heroCta: "Get started free", heroHow: "How it works",
      featTitle: "Everything you need to", featGradient: "truly learn",
      featSub: "Designed to be brief, effective and adapted to your level.",
      feat1Title: "Smart challenges", feat1Desc: "A brand-new micro-challenge every day, tailored to your CEFR level. Just 5 minutes.",
      feat2Title: "AI Tutor", feat2Desc: "Personalised feedback instantly. The AI explains your mistakes and celebrates your wins.",
      feat3Title: "Streaks & XP", feat3Desc: "Earn XP, keep your daily streak and level up with every completed challenge.",
      feat4Title: "Vocabulary notebook", feat4Desc: "Save words you learn and review them whenever you want. Your personal dictionary.",
      hiwTitle: "Getting started is", hiwGradient: "super easy", hiwSub: "Three steps and you'll be learning today.",
      step1Title: "Create your profile", step1Desc: "Choose the language to learn and tell us your current level. Less than 2 minutes.",
      step2Title: "Complete your daily challenge", step2Desc: "Every day a new exercise: listen, write or answer questions with your AI tutor.",
      step3Title: "Track your progress", step3Desc: "Watch yourself level up, maintain your streak and build vocabulary week by week.",
      langTitle: "Available languages", langSub: "Choose the one that interests you most. You can learn several at once.",
      langEn: "English", langFr: "French", langUa: "Ukrainian", langEs: "Spanish",
      premTitle: "Unlock the AI tutor without limits",
      premSub: "Chat with your tutor whenever you want, access all courses and advanced challenges. From just €5/month.",
      premBtn: "See plans",
      ftLogin: "Log in", ftRegister: "Sign up", ftPricing: "Pricing",
      ftCopy: "© 2026 CoreSpeak. All rights reserved.",
  ...
  fr: {
    ...
    landing: {
      ...
      heroSub: "Micro-défis de 5 minutes par jour. Feedback instantané de votre tuteur IA. Construisez l'habitude d'apprendre, jour après jour.",
      heroCta: "Commencer gratuitement", heroHow: "Comment ça marche",
      featTitle: "Tout ce qu'il faut pour", featGradient: "vraiment apprendre",
      featSub: "Conçu pour être bref, efficace et adapté à votre niveau.",
      feat1Title: "Défis intelligents", feat1Desc: "Un nouveau micro-défi chaque jour, adapté à votre niveau CECR. Seulement 5 minutes.",
      feat2Title: "Tuteur IA", feat2Desc: "Feedback personnalisé instantané. L'IA explique vos erreurs et célèbre vos réussites.",
      feat3Title: "Séries & XP", feat3Desc: "Accumulez des XP, maintenez votre série quotidienne et montez de niveau.",
      feat4Title: "Carnet de vocabulaire", feat4Desc: "Sauvegardez les mots appris et révisez-les quand vous voulez. Votre dictionnaire personnel.",
      hiwTitle: "Commencer est", hiwGradient: "très simple", hiwSub: "Trois étapes et vous apprenez dès aujourd'hui.",
      step1Title: "Créez votre profil", step1Desc: "Choisissez la langue et indiquez votre niveau. Moins de 2 minutes.",
      step2Title: "Complétez votre défi quotidien", step2Desc: "Chaque jour un nouvel exercice : écoutez, écrivez ou répondez avec votre tuteur IA.",
      step3Title: "Suivez vos progrès", step3Desc: "Observez comment vous montez de niveau, maintenez votre série et accumulez du vocabulaire.",
      langTitle: "Langues disponibles", langSub: "Choisissez celle qui vous intéresse le plus. Vous pouvez en apprendre plusieurs à la fois.",
      langEn: "Anglais", langFr: "Français", langUa: "Ukrainien", langEs: "Espagnol",
      premTitle: "Débloquez le tuteur IA sans limites",
      premSub: "Discutez avec votre tuteur quand vous voulez, accédez à tous les cours. À partir de 5 €/mois.",
      premBtn: "Voir les offres",
      ftLogin: "Se connecter", ftRegister: "S'inscrire", ftPricing: "Tarifs",
      ftCopy: "© 2026 CoreSpeak. Tous droits réservés.",
  ...
  de: {
    ...
    landing: {
      ...
      heroSub: "5-Minuten-Micro-Challenges täglich. Sofortiges Feedback von deinem KI-Tutor. Bau die Lerngewohnheit auf, Tag für Tag.",
      heroCta: "Kostenlos starten", heroHow: "So funktioniert's",
      featTitle: "Alles was du brauchst zum", featGradient: "echten Lernen",
      featSub: "Kurz, effektiv und auf dein Niveau zugeschnitten.",
      feat1Title: "Smarte Challenges", feat1Desc: "Jeden Tag eine neue Micro-Challenge, abgestimmt auf dein GER-Niveau. Nur 5 Minuten.",
      feat2Title: "KI-Tutor", feat2Desc: "Personalisiertes Feedback in Sekunden. Die KI erklärt Fehler und feiert Erfolge.",
      feat3Title: "Serien & XP", feat3Desc: "Sammle XP, halte deine Tagesserie und steige mit jeder Challenge auf.",
      feat4Title: "Vokabelheft", feat4Desc: "Speichere gelernte Wörter und übe sie wann immer du willst. Dein persönliches Wörterbuch.",
      hiwTitle: "Starten ist", hiwGradient: "ganz einfach", hiwSub: "Drei Schritte und du lernst noch heute.",
      step1Title: "Profil erstellen", step1Desc: "Wähle die Sprache und gib dein Niveau an. Weniger als 2 Minuten.",
      step2Title: "Tägliche Challenge abschließen", step2Desc: "Jeden Tag eine neue Übung: hören, schreiben oder mit KI-Tutor antworten.",
      step3Title: "Fortschritt verfolgen", step3Desc: "Beobachte, wie du aufsteigst, deine Serie hältst und Vokabeln sammelst.",
      langTitle: "Verfügbare Sprachen", langSub: "Wähle die interessanteste. Mehrere können gleichzeitig gelernt werden.",
      langEn: "Englisch", langFr: "Französisch", langUa: "Ukrainisch", langEs: "Spanisch",
      premTitle: "KI-Tutor ohne Grenzen freischalten",
      premSub: "Chatte wann immer du willst, greife auf alle Kurse zu. Ab nur 5 €/Monat.",
      premBtn: "Pläne ansehen",
      ftLogin: "Anmelden", ftRegister: "Registrieren", ftPricing: "Preise",
      ftCopy: "© 2026 CoreSpeak. Alle Rechte vorbehalten.",
  ...
  uk: {
    ...
    landing: {
      ...
      heroSub: "Мікро-завдання на 5 хвилин щодня. Миттєвий відгук від вашого ШІ-репетитора. Формуйте звичку вчитися день за днем.",
      heroCta: "Почати безкоштовно", heroHow: "Як це працює",
      featTitle: "Все, що потрібно для", featGradient: "справжнього навчання",
      featSub: "Розроблено коротким, ефективним і адаптованим до вашого рівня.",
      feat1Title: "Розумні завдання", feat1Desc: "Нове мікро-завдання щодня, адаптоване до вашого рівня CEFR. Лише 5 хвилин.",
      feat2Title: "ШІ-репетитор", feat2Desc: "Персоналізований відгук миттєво. ШІ пояснює помилки і відзначає успіхи.",
      feat3Title: "Серії та XP", feat3Desc: "Накопичуйте XP, підтримуйте щоденну серію і підвищуйте рівень.",
      feat4Title: "Словник", feat4Desc: "Зберігайте вивчені слова і повторюйте їх коли завгодно. Ваш особистий словник.",
      hiwTitle: "Почати дуже", hiwGradient: "просто", hiwSub: "Три кроки — і ви вже навчаєтесь сьогодні.",
      step1Title: "Створіть профіль", step1Desc: "Оберіть мову та вкажіть поточний рівень. Менше 2 хвилин.",
      step2Title: "Виконайте щоденне завдання", step2Desc: "Щодня нова вправа: слухайте, пишіть або відповідайте з ШІ-репетитором.",
      step3Title: "Відстежуйте прогрес", step3Desc: "Спостерігайте, як ви підвищуєте рівень, підтримуєте серію та накопичуєте словник.",
      langTitle: "Доступні мови", langSub: "Оберіть ту, що вас цікавить. Можна вивчати кілька одночасно.",
      langEn: "Англійська", langFr: "Французька", langUa: "Українська", langEs: "Іспанська",
      premTitle: "Відкрийте ШІ-репетитора без обмежень",
      premSub: "Спілкуйтеся з репетитором коли завгодно, отримайте доступ до всіх курсів. Від 5 €/міс.",
      premBtn: "Переглянути плани",
      ftLogin: "Увійти", ftRegister: "Зареєструватися", ftPricing: "Ціни",
...
function corespeakLessonPageHref(lessonNav, baseOpts) {
  if (!lessonNav || lessonNav.id == null) return null;
  const params = new URLSearchParams();
  params.set("lesson_id", String(lessonNav.id));
  if (baseOpts && baseOpts.lang) params.set("lang", String(baseOpts.lang));
  if (baseOpts && baseOpts.courseId) params.set("course_id", String(baseOpts.courseId));
  params.set(
    "level",
    String(lessonNav.cefr_level || (baseOpts && baseOpts.level) || "A1")
  );
...
function corespeakRenderCatalogExercises(container, exercisesJson, lc, opts) {
  ...
  if (blocks.length >= 1) {
    ...
    function goPrev() {
      ...
      } else if (prevLessonHref) {
        window.location.href = prevLessonHref;
      }
    }
    ...
    function showExercise(index) {
      ...
      nextBtns.forEach(function (btn) {
        btn.disabled = currentIndex === blocks.length - 1 && !nextLessonHref;
      });
    }
    ...
    function makeSideBtn(direction) {
      ...
      btn.innerHTML = isPrev
        ? '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/></svg>'
        : '<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/></svg>';
      btn.addEventListener("click", function () {
        if (isPrev) goPrev();
        else goNext();
      });
    ...
    counterRow.className = "lesson-exercise-nav lesson-exercise-nav--counter";
...
async function loadLessonPage() {
  ...
  corespeakRenderCatalogExercises(exWrap, detail.exercises_json || "{}", lc, {
    ...
    lang: lang,
    level: level,
    courseId: detail.course_id || params.get("course_id") || "",
    prevLesson: detail.prev_lesson || null,
    nextLesson: detail.next_lesson || null,
  });
